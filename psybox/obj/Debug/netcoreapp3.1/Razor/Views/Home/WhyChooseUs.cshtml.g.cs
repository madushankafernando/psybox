#pragma checksum "/Users/madushankafernando/Projects/psybox/psybox/Views/Home/WhyChooseUs.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "59ceb1264c03ec1161e01b3f7549c3a5e276a950"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"59ceb1264c03ec1161e01b3f7549c3a5e276a950", @"/Views/Home/WhyChooseUs.cshtml")]
  ...
  ");
        ...
        <div style=""width: 100%;float: left;"">
            ...
            WriteLiteral(@"           </div><!-- /heading -->
                            ...
                            <img src=""../assets/images/about/sing");
            WriteLiteral(@"nture.png"" alt=""singnture"" class=""mt-30"">
                        </div><!-- /.col-xl-7 -->
                    </div><!-- /.row -->
                </div><!-- /.container -->
                        ...
                        <div class=""col-sm-12 col-md-12 col-lg-5"">
                            <div class=""sticky-top"">
                                ...
                                <h3 class=""heading__title color-white"">
                                    Improve Efficiency And Provide Better Experience By Our");
            WriteLiteral(@" IT
                                    Solutions!
                                </h3>
                                ...
                                <div class=""d-flex flex-wrap mt-40 mb-30"">
                                    ...
                                    <a href=""#"" class=""");
            WriteLiteral(@"btn btn__white btn__outlined"">Request A Demo</a>
                                </div>
                            </div>
                        </div><!-- /col-lg-5 -->
 ...
 ");
            WriteLiteral(@"                                           <i class=""icon-arrow-right icon-outlined""></i>
                                    ...
                                    <div class=""feature-item"">
                                        ...
                                        <a href=""#"" class=""btn__link"">
                                            ...
                                            <sp");
            WriteLiteral(@"an>Read More</span>
                                        </a>
                                    </div><!-- /.feature-item -->
                                    <!-- Feature item #3 -->
                                    <div class=""feature-item"">
   ...
   ");
                    ...
                    <div class=""row"">
                        <div class=""col-sm-12 col-md-12 col-lg-12 col-xl-6 offset-xl-2"">
                            <div class=""heading mb-60"">
                                ...
                                <h3 class=""heading__title"">1900 Resourses &");
            WriteLiteral(@" 870 Satisfied Users Over The Globe!</h3>
                            </div><!-- /.heading -->
                        </div><!-- /.col-xl-6 -->
                        <div class=""col-12"">
            ...
            WriteLiteral(@"                 <i class=""fas fa-star""></i>
                                   ...
                                   ");
            WriteLiteral(@"         <p class=""testimonial__meta-desc"">7oroof Inc</p>
                                        </div>
                                ...
                                <div class=""testimonial-item"">
                                   ...
                                   ");
            WriteLiteral(@"     determination turned it into an awesome and great project which make me happy.
                                    </h3>
                                    <div class=""testimonial__meta d-flex align-items-center"">
                                        <div class=""testimonial__thmb mr-20"">
            ...
            WriteLiteral(@"ial-item"">
                                    ...
                                    <div class=""testimonial__meta d-flex align-items-center"">
                                        <div class=""testimonial__thmb mr-20"">
                                            <img src=""../asset");
            WriteLiteral(@"s/images/testimonials/thumbs/3.png"" alt=""author thumb"">
                                        </div><!-- /.testimonial-thumb -->
                                        <div>
                                            <h4 class=""testimonial__meta-title"">John Peter</h4>
        ...
        ");
            WriteLiteral(@"                                <i class=""fas fa-star""></i>
                                    ...
                                    <div class=""testimonial__meta d-flex align-items-center"">
                                        ...
                                        <div>
                                            ...
                                            <p class=""testimonial__meta-desc"">Prom");
            WriteLiteral(@"ina</p>
                                        </div>
                                    </div><!-- /.testimonial-meta -->
                                </div><!-- /. testimonial-item -->
                                ...
                                <div class=""testimonial-item"">
                                    ...
                                    <h3 class=""testimonial__title"">
                                        My project was a simple & small task, but the persistence and
                                        determination turned it into an awesome and g");
            WriteLiteral(@"reat project which make me happy.
                                    </h3>
                                    <div class=""testimonial__meta d-flex align-items-center"">
                                        <div class=""testimonial__thmb mr-20"">
                                            <img src=""../assets/images/testimonials/thumbs/4.png"" alt=""author thumb"">
                                ...
                                <div class=""testimonial-item"">
                                    <div c");
            WriteLiteral(@"lass=""testimonial__rating"">
                                        <i class=""fas fa-star""></i>
                                        <i class=""fas fa-star""></i>
                                        <i class=""fas fa-star""></i>
                                        <i class=""fas fa-star""></i>
                                    ...
                                    <div class=""testimonial__meta d-flex align-items-center"">
                                        <div class=""testimonial__thmb mr-20"">
                                            <img src=""../assets/images/testimonials/thumbs/4.png"" alt=""author ");
            WriteLiteral(@"thumb"">
                                        </div><!-- /.testimonial-thumb -->
                                        <div>
                                            <h4 class=""testimonial__meta-title"">Martin Hope</h4>
            ...
            WriteLiteral(@"lass=""client"">
                                ...
                                <div class=""client"">
                                    ...
                                    <i");
            WriteLiteral(@"mg src=""../assets/images/clients/6.png"" alt=""client"">
                                </div><!-- /.client -->
                                <div class=""client"">
